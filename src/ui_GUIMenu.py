...
"}")
        ...
        self.TutorialHead = QLabel(self.Tutorial_Page)
        self.TutorialHead.setObjectName(u"TutorialHead")
        self.TutorialHead.setGeometry(QtCore.QRect(0, 0, 161, 91))
        font1 = QFont()
        font1.setPointSize(25)
        font1.setBold(True)
        self.TutorialHead.setFont(font1)
        ...
        self.TutorialDis = QLabel(self.Tutorial_Page)
        self.TutorialDis.setObjectName(u"TutorialDis")
        self.TutorialDis.setGeometry(QtCore.QRect(50, 200, 611, 101))
        fontDis = QtGui.QFont()
        fontDis.setPointSize(12)
        self.TutorialDis.setFont(fontDis)
        self.TutorialDis.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.TutorialDis.setWordWrap(True)
        ...
        self.FreeHead = QLabel(self.Free_Page)
        self.FreeHead.setObjectName(u"FreeHead")
        self.FreeHead.setGeometry(QtCore.QRect(20, 20, 191, 61))
        self.FreeHead.setFont(font1)
        self.Freedis = QLabel(self.Free_Page)
        self.Freedis.setObjectName(u"Freedis")
        self.Freedis.setGeometry(QtCore.QRect(140, 230, 411, 101))
        self.Freedis.setFont(fontDis)
        self.Freedis.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.Freedis.setWordWrap(True)
        ...
        self.QuizHead = QLabel(self.Quiz_Page)
        self.QuizHead.setObjectName(u"QuizHead")
        self.QuizHead.setGeometry(QtCore.QRect(0, 10, 171, 71))
        self.QuizHead.setFont(font1)
        self.QuizDis1 = QLabel(self.Quiz_Page)
        self.QuizDis1.setObjectName(u"QuizDis1")
        self.QuizDis1.setGeometry(QtCore.QRect(100, 90, 531, 151))
        self.QuizDis1.setFont(fontDis)
        self.QuizDis1.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.QuizDis1.setWordWrap(True)
        self.QuizDis2 = QLabel(self.Quiz_Page)
        self.QuizDis2.setObjectName(u"QuizDis2")
        self.QuizDis2.setGeometry(QtCore.QRect(100, 280, 531, 121))
        self.QuizDis2.setFont(fontDis)
        self.QuizDis2.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.QuizDis2.setWordWrap(True)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.TutorialHead.setText(QCoreApplication.translate("MainWindow", u"Tutorials!", None))
